...
public class DestinationService {
    Destination[] activities = new Destination[] {
            new Destination(1, "Éco-lodge de la Forêt Verte",
            ...
            new Destination(2, "Randonnée zéro déchet dans les Alpes",
            ...
            new Destination(3, "Séjour à la ferme biologique de la Vallée",
            ...
            new Destination(4, "Camping écologique en bord de mer",
            ...
            new Destination(5, "Balade en vélo électrique dans les vignobles",
            ...
            new Destination(6, "Initiation à la plongée écoresponsable",
